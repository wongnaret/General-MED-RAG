...
class AgenticChunker:
    ...
    def _find_relevant_chunk(self, proposition):
        ...
        try:
            ...
            # Fallback for local LLMs (Ollama / Llama 3) lacking legacy OpenAI function calling
            import re
            match = re.search(r'\b[a-zA-Z0-9]{5}\b', chunk_found)
            if match and match.group(0) in self.chunks:
